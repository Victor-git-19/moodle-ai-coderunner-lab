...
Версии проверены 13 июля 2026 года. По обязательному требованию учебного задания используется строго Moodle 5.2.1. В `public/admin/environment.xml` этого выпуска указаны минимум PHP 8.3 и MariaDB 10.11.
...
| Модель | qwen2.5-coder:1.5b | Небольшая code-модель примерно на 1 ГБ |
